# Finds if Triangle is installed and determines the locations of the include
...
find_path(
  TRIANGLE_INCLUDE_DIR triangle.h
  PATH_SUFFIXES triangle
  DOC "Location of Triangle header file directory")
find_package_handle_standard_args(Triangle DEFAULT_MSG TRIANGLE_LIBRARY
...
if(Triangle_FOUND AND NOT TARGET Triangle::Triangle)
  ...
  set_target_properties(
    Triangle::Triangle
    PROPERTIES IMPORTED_LOCATION "${TRIANGLE_LIBRARY}"
